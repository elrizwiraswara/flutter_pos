...
class MockUserLocalDatasourceImpl extends _i1.Mock
  ...
  @override
  _i4.Future<String> createUser(_i5.UserModel? user) => (super.noSuchMethod(
        Invocation.method(
          #createUser,
          [user],
        ),
  ...
  @override
  _i4.Future<_i5.UserModel?> getUser(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getUser,
          [id],
        ),
...
class MockQueuedActionLocalDatasourceImpl extends _i1.Mock
  ...
  @override
  _i4.Future<void> deleteQueuedAction(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteQueuedAction,
          [id],
        ),
